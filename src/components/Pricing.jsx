...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 className="text-2xl text-white font-bold md:text-4xl md:leading-tight dark:text-white">Pricing</h2>
  ...
  <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    {/* <!-- Card --> */}
    <div className="flex flex-col border bg-white border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
      ...
      <p className="mt-2 text-md text-gray-500"> Free for Security services</p>
    ...
    {/* <!-- Card --> */}
    <div className="flex flex-col  bg-white border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
    ...
    {/* <!-- Card --> */}
    <div className="flex flex-col  bg-white border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
