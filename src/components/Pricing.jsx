...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 className="text-2xl sm:mt-20 mt-64 text-white font-bold md:text-4xl md:leading-tight dark:text-white">Web Development Pricing</h2>
  ...
  <div className="mt-12 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:items-center">
    ...
    <div className="flex flex-col  bg-white border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
      ...
      <a className="mt-5 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#contact-us">
        Get Started
      </a>
    </div>
    {/* <!-- End Card --> */}
