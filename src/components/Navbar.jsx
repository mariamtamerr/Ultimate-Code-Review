...
const Navbar = () => {
  ...
  return (
    <div className=''>
      {/* <!-- ========== HEADER ========== --> */}
<header className="sm:flex sm:bg-slate-900  sm:justify-start sm:flex-nowrap z-50 sm:w-full fixed text-white text-sm sm:py-0  dark:bg-gray-800 dark:border-gray-700">
